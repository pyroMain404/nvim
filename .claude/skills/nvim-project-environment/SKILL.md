...
| Neovim eredita l'ambiente della shell che l'ha avviato: una variabile esportata in un terminale rende un progetto "funzionante" lì e rotto se aperto da un'icona | ciò che serve al progetto va nel `.nvim.lua`, non nel profilo della shell; il sintomo "funziona solo dal terminale" è questo |
